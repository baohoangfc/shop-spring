		...
		<div class="header-top-inner">
			<div class="cnt-account">
				<ul class="list-unstyled">
					...
					<li><a href="${pageContext.request.contextPath }/login"><i class="icon fa fa-sign-in"></i>Login</a></li>
					<li><a href="${pageContext.request.contextPath }/logout"><i class="icon fa fa-sign-out"></i>Logout</a></li>
				</ul>
			</div><!-- /.cnt-account -->
	...
	<div class="dropdown dropdown-cart">
		...
		<ul class="dropdown-menu">
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<h3 class="name"><a href="index.php?page-detail">${item.name_product }</a></h3>
			...
			<div class="clearfix cart-total">
				...
				<a href="${pageContext.request.contextPath }/cart" class="btn btn-upper btn-primary btn-block m-t-20">View Cart</a>	
			</div><!-- /.cart-total-->
	...
	<div class="nav-outer">
		<ul class="nav navbar-nav">
			<li class="active dropdown yamm-fw">
				<a href="${pageContext.request.contextPath }/" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Home</a>				
			</li>
