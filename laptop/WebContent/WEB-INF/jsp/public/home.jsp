...
<div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="${pageContext.request.contextPath }/${slugUtil.createSlug(obj.name_product)}/${obj.id_product}.html">
				<img  src="${pageContext.request.contextPath }/files/${obj.picture}" data-echo="${pageContext.request.contextPath }/files/${obj.picture}" alt=""></a>
			</div><!-- /.image -->			
